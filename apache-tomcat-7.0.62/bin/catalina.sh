...
CATALINA_OPTS="-server -Xms1536m -Xmx4096m -XX:PermSize=256m -XX:MaxPermSize=512m -XX:+DisableExplicitGC -Dfile.encoding=utf-8 -noverify -Dlog4j1.compatibility=true"
